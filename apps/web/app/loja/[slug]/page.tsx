...
export default function LojaPage() {
    ...
    const openModal = (type: 'user' | 'produto', data: UsuarioLoja | Produto | null = null) => {
        ...
        if (type === 'user') {
            ...
            setFormDataProduto({
                nome: (data as Produto)?.nome || "",
                sku: (data as Produto)?.sku || "",
                preco: (data as Produto)?.preco || 0,
                preco_custo: (data as Produto)?.preco_custo || 0,
                ...
                imagem_url: (data as Produto)?.imagem_url || "",
            });
        }
        setShowModal(true);
    };
