...
export function DefinicoesTab({
    ...
    return (
        <div className="space-y-6">
            ...
            {/* TABS INTERNAS */}
            <div className="transition" style={{ backgroundColor: 'var(--cor-card)', borderRadius: radius, padding: cardSize === 'grande' ? '4px' : '4px' }}>
            ...
            {/* CONTEÚDO */}
            <div className="transition border" style={{ backgroundColor: 'var(--cor-card)', borderColor: 'var(--cor-borda)', borderRadius: radius, padding }}>
                {tabAtiva === "aparencia" && (
                    <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <input
                                        ...
                                        style={{ backgroundColor: 'var(--cor-card)', borderColor: 'var(--cor-borda)', color: 'var(--cor-texto)', borderRadius: radius }}
                                    />
                                </div>
                            </div>
                        ...
                        <div className="p-4" style={{ backgroundColor: 'var(--cor-card)', borderRadius: radius }}>
                ...
                {tabAtiva === "notificacoes" && (
                    <div className="space-y-4">
                        ...
                        {["Estoque Baixo", "Nova Venda", "Cliente Novo"].map(n => (
                            <div key={n} className="flex items-center justify-between p-4" style={{ backgroundColor: 'var(--cor-card)', borderRadius: radius }}>
