            ...
            >
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    <DialogHeader className="p-5 pb-3 shrink-0">
                        <DialogTitle className="text-lg font-bold flex items-center justify-center gap-2" style={{ color: 'var(--cor-texto)' }}> {/* <- CENTRALIZADO */}
                    ...
                    <div className="grid gap-4 py-4 px-5 overflow-y-auto flex-1 min-h-0"> {/* <- PADRAO */}
                        {!isAbrir && (
                        ...
                        <div className="grid gap-1.5"> {/* <- 1 COLUNA */}
                            ...
                            <Input
                                ...
                                className="text-sm h-10 w-full" // <- PADRAO
                    ...
                    <DialogFooter className="p-4 border-t shrink-0 flex-col gap-2" style={{ backgroundColor: 'var(--cor-card)', borderColor: 'var(--cor-borda)' }}> {/* <- BOTOES EMPILHADOS */}
                        <Button type="submit" disabled={loading} className="gap-2 text-sm w-full h-10 font-bold" style={{ background: isAbrir? '#22c55e' : '#ef4444', color: '#fff', borderRadius: 'var(--radius)' }}>
