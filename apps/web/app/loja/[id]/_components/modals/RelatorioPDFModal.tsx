    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            ...
            >
                ...
                {/* FOOTER FIXO EMBAIXO */}
                <div
                    className="fixed bottom-5 left-0 right-0 px-3 pt-1.5 pb-[calc(0.75rem+env(safe-area-inset-bottom))] border-t flex flex-row gap-2 z-[60]" // 1. adicionei FLEX 2. bottom-0 3. z-[60]
