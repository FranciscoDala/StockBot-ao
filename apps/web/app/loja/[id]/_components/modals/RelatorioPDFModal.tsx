...
export function RelatorioPDFModal({
    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-5xl h-[90vh] flex flex-col p-0" style={{ backgroundColor: 'var(--cor-card)', borderRadius: '16px' }}>
                <DialogHeader className="p-4 border-b" style={{ borderColor: 'var(--cor-borda)' }}>
                    <DialogTitle style={{ color: 'var(--cor-texto)' }}>Pré-visualização: {periodoTexto}</DialogTitle>
                </DialogHeader>

                <div className="flex-1 flex items-center justify-center p-4" style={{ color: 'var(--cor-texto-sec)' }}>
