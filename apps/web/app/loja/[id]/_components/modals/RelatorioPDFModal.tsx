...
import { Dialog, DialogContent } from "@/components/ui/dialog" // remove Header, Title, Footer
        ...
        <Dialog open={open} onOpenChange={onClose}>
            ...
            >
                ...
                <div
                    ...
                    style={{ borderColor: 'var(--cor-borda)', backgroundColor: 'var(--cor-card)' }}
                >
                    <Button
                        variant="outline"
                        onClick={onClose}
