            ...
            >
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
                    <DialogHeader className="p-5 pb-3 shrink-0">
                        <DialogTitle className="text-lg font-bold text-center flex items-center justify-center gap-2" style={{ color: 'var(--cor-texto)' }}>
                    ...
                    <DialogFooter className="p-4 border-t shrink-0 flex-col sm:flex-row gap-2" style={{ backgroundColor: 'var(--cor-card)', borderColor: 'var(--cor-borda)' }}> {/* <- AJUSTADO */}
                        <Button
                          ...
                          style={{ background: '#f97316', color: '#fff', borderRadius: 'var(--radius)' }}
                        >
