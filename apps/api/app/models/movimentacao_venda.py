...
if TYPE_CHECKING:
    from app.models.venda import Venda # <- ADICIONA ISSO

class MovimentoVenda(BaseModel):
    ...
    # Relacionamentos
    venda: Mapped["Venda"] = relationship("Venda", back_populates="movimentos") # <- Agora ele sabe quem é "Venda"
